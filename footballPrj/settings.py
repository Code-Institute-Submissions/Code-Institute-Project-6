"""
Django settings for footballPrj project.
...
SECRET_KEY = 'django-insecure-lvb9lqcn13dkdg@eorwl60h(m-5nqdc74z05ou^#(y+d1k*s8c'
...
WSGI_APPLICATION = 'footballPrj.wsgi.application'
